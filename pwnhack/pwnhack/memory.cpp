...
//patch overwritten assembly with original bytes(most of the time), usually to disable a hack but can be used otherwise
...
//nop specified no. of bytes starting from the specified address
